...
- `@statekit-vue/shared@0.1.1` 与 `@statekit-vue/vue@0.1.1` 当前已发布到 npm，均为 `public` 且 `latest` 指向 `0.1.1`。
- 本地 workspace 当前已将下一次发版线准备到 `0.1.2`，但在实际执行 npm publish 之前，对外可安装的最新版本仍然是 `0.1.1`。
